...
// New Changes
const AddProductCategories = forwardRef((props: IProps, ref) => {
  ...
  return (
    <View>
            ...
            <SubTitle style={[styles.drop]}>
              {value ? (
                <Text style={styles.selected}>
                  {value} {subValue && ","} {subValue} {subValue2 && ","}{" "}
                  {subValue2}
                </Text>
              ) : (
                <Text style={styles.selected}>{draftvalue}</Text>
              )}
            </SubTitle>
            {icons ? (
            ...
            {showForm == true ? (
              <View style={styles.block}>
                ...
                <View style={styles.list}>
                  ...
                  >
                    <SubTitle style={[styles.label, styles.sublabel]}>
                      {toAdd}
                    </SubTitle>
                    <TextInput
                    ...
                    >
                      <View style={{ width: "48%" }}>
                        <ScreensButton
                          ...
                          onPress={() => {
                            AddMoreMasterCategory(type);
                            refetch();
                            handleDrafts(draftType, masterCategory);
                          }}
                        ...
                        return item !== "" ? (
                          ...
                          >
                            <TouchableOpacity
                              ...
                              onPress={() => {
                                HandleMasterSelect(item, index);
                                handleDrafts(draftType, item);
                              }}
                            >
                              <View style={styles.listBlock}>
                                <SubTitle style={styles.listText}>
                                  {item}
                                </SubTitle>
                              </View>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity
                              onPress={() => {
                                deletePopup(item, type, index);
                              }}
                              style={{
                                display: setlected == item ? "none" : "flex",
                                flex: 1,
                              }}
                            >
                              {editTable ? null : (
            ...
            {showForm == true ? (
              <View style={styles.block}>
                <SubTitle style={styles.label}>
                  {t("common:SELECT_SUB_CATEGORY")} 1
                </SubTitle>
                <View style={styles.list}>
                  <SubTitle style={[styles.label, styles.sublabel]}>
                    {toAdd}
              ...
              <View style={styles.block}>
                ...
                <View style={styles.fullWidth}>
                  <ScreensButton
                    onPress={HandleSubCategoryCancel}
                    btnTitle={t("common:CANCEL")}
                    bgcolor={theme.colors.red[600]}
                    iconName={""}
                  />
      ...
      <Actionsheet
        isOpen={showSubSheet2}
        onClose={() => setShowSubSheet2(false)}
      >
        <Actionsheet.Content style={styles.sheetstyle}>
          <Box w="100%" h="100%">
            {showForm == true ? (
              <View style={styles.block}>
                <SubTitle style={styles.label}>
                  {t("common:SELECT_SUB_CATEGORY")} 2
                </SubTitle>
                <View style={styles.list}>
                  <SubTitle style={[styles.label, styles.sublabel]}>
                    {toAdd}
              ...
              <View style={styles.block}>
                ...
                <View style={styles.list}>
                  ...
                  >
                    {subList2 &&
                      subList2?.map((item: any, index: any) => {
                ...
                <View style={styles.fullWidth}>
                  <ScreensButton
                    onPress={HandleSubCategory2Cancel}
                    btnTitle={t("common:CANCEL")}
                    bgcolor={theme.colors.red[600]}
                    iconName={""}
                  />
